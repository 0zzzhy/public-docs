![image2 jpeg](../../../../assets/products/video-extensometer/image2.jpeg)
...
![image3 jpeg](../../../../assets/products/video-extensometer/image3.jpeg)
...
![image4 jpeg](../../../../assets/products/video-extensometer/image4.jpeg)

图 2 设备主机前端图片

![image5 jpeg](../../../../assets/products/video-extensometer/image5.jpeg)

图 3.设备主机后端图片

2)  **光源：**通常情况下，设备主机自带集成光源，在常规场景和高低温箱中可选配条形灯（图 3.右），在微小试样、高温炉等场景可选配射灯（图 3.左）。

![image6 jpeg](../../../../assets/products/video-extensometer/image6.jpeg)
![image7 jpeg](../../../../assets/products/video-extensometer/image7.jpeg)
...
![image8 png](../../../../assets/products/video-extensometer/image8.png)

图 4.旋转支架

2.  便携式三脚架（图 5），可自由调节系统水平和设备空间距离。

![image9 png](../../../../assets/products/video-extensometer/image9.png)
![image10 png](../../../../assets/products/video-extensometer/image10.png)
...
![image11 jpeg](../../../../assets/products/video-extensometer/image11.jpeg)

2.  在高温试验时，使用酒精与高温材料混合制作高温标记点，或使用高温油漆笔制作标记点，在常温试验时如不方便粘贴标准圆形标记点，也可使用普通油漆笔制作标记点。

![image12 jpeg](../../../../assets/products/video-extensometer/image12.jpeg)
...
![image13 png](../../../../assets/products/video-extensometer/image13.png)

![image14 png](../../../../assets/products/video-extensometer/image14.png)

安装完成后桌面上将生成 2 个快捷方式图标![image15 png](../../../../assets/products/video-extensometer/image15.png)，一般只会用到 Galaxy
Viewer 软件![image16 png](../../../../assets/products/video-extensometer/image16.png)。
...
![image17 png](../../../../assets/products/video-extensometer/image17.png)

![image18 png](../../../../assets/products/video-extensometer/image18.png)

安装完成后，桌面上会自动生成快捷方式图标![image19 png](../../../../assets/products/video-extensometer/image19.png)。

# 4. 硬件安装 <span id="_Toc16079"></span>

-   固定三脚架或安装旋转支架。

-   通过设备底部的 1/4 螺纹孔，将设备安装至三脚架或旋转支架上。

    ![image20 jpeg](../../../../assets/products/video-extensometer/image20.jpeg)
    ![image21 png](../../../../assets/products/video-extensometer/image21.png)

-   开启光源系统：将电源线连接至光源控制器上，再通过黑色数据线将光源控制器与光源连接。

    ![image22 png](../../../../assets/products/video-extensometer/image22.png)
...
-   将做好标记的试样放置于合适的夹持处，打开“Visual
    Extensometer”软件![image19 png](../../../../assets/products/video-extensometer/image19.png)，调整至合适的曝光参数（5000-20000μs）。
...
![image23 png](../../../../assets/products/video-extensometer/image23.png)

![image24 png](../../../../assets/products/video-extensometer/image24.png)

# 5. 软件使用 <span id="_Toc7314"></span>
...
4)  双击 VisualExtensometer2D 软件桌面快捷方式图标![image25 png](../../../../assets/products/video-extensometer/image25.png)打开软件。打开软件界面如下：
...
![image28 png](../../../../assets/products/video-extensometer/image28.png)
...
![image29 png](../../../../assets/products/video-extensometer/image29.png)

1.  **保存图片：**点击保存图片选项，可在计算时进行保存图片操作。

未开启保存图片状态：![image30 png](../../../../assets/products/video-extensometer/image30.png)

已开启保存图片状态：![image31 png](../../../../assets/products/video-extensometer/image31.png)
...
![image32 png](../../../../assets/products/video-extensometer/image32.png)![image33 png](../../../../assets/products/video-extensometer/image33.png)

6.  **测试标定：**在软件内进行标定操作后，可通过测试标定功能来验证标定精度。在标定位置采集一张标定板正视图图片，点击“标定板图片目录”后![image34 png](../../../../assets/products/video-extensometer/image34.png)按钮，选择这种标定板正视图图片，点击“计算”，可得出“X 向空心圆点间距”和“Y 向空心圆点间距”，将此数据与标定上原点间距数值×3 进行比较，可得出标定计算误差，如误差在可接受范围内，则此标定无问题。

![image35 png](../../../../assets/products/video-extensometer/image35.png)

### 参数配置：点击菜单栏“配置”按钮，可进行软硬件参数的配置

![image36 png](../../../../assets/products/video-extensometer/image36.png)
...
![image37 png](../../../../assets/products/video-extensometer/image37.png)
...
![image38 png](../../../../assets/products/video-extensometer/image38.png)

3.  **通讯参数配置：**此配置主要用于与试验机软件或硬件进行数据通讯，支持将试验机力值信号通过采集卡传输至本软件，同时可将软件计算的原始标距、延伸量等数据回传至试验机软件。

    主要通讯方式包括 UDP 数字信号通讯、模拟信号通讯和串口通讯。

![image39 png](../../../../assets/products/video-extensometer/image39.png)
...
![image40 png](../../../../assets/products/video-extensometer/image40.png)
...
![image41 png](../../../../assets/products/video-extensometer/image41.png)
...
![image42 png](../../../../assets/products/video-extensometer/image42.png)
...
![image43 png](../../../../assets/products/video-extensometer/image43.png)
...
![image44 png](../../../../assets/products/video-extensometer/image44.png)

7.  **测量结果：**可选择是否在开始计算时输入实验名称

![image45 png](../../../../assets/products/video-extensometer/image45.png)

### 计算模式

点击菜单栏“计算模式”可选择不同的计算模式

![image46 png](../../../../assets/products/video-extensometer/image46.png)
...
![image49 png](../../../../assets/products/video-extensometer/image49.png)

2.  设置存图路径，点击左上方工具栏“设置按钮” - 选择“存图设置” - 更改存图位置。

注意：由于标定需要两组图片，所以建议设置两个存图文件夹，一个用来存放“尺寸标定图”，一个用来存放“内参标定图”。

![image50 png](../../../../assets/products/video-extensometer/image50.png)![image51 png](../../../../assets/products/video-extensometer/image51.png)

3.  拍摄尺寸标定图，将存图路径设置为“尺寸标定图”文件夹，将标定板按照“正视图”姿势摆放，点击画面左上方“保存当前图片按钮”以拍摄尺寸标定图，拍摄一张即可。

![image52 png](../../../../assets/products/video-extensometer/image52.png)![image53 png](../../../../assets/products/video-extensometer/image53.png)

4.  拍摄内参标定图，将存图路径设置为“内参标定图”文件夹，将标定板按照下图姿势摆放，每个姿势都需点击画面左上方“保存当前图片按钮”以拍摄当前姿势标定图，共需拍摄 13 张。

![image54 jpeg](../../../../assets/products/video-extensometer/image54.jpeg)

### 输出报告

如需使用此软件出具报告，可点击菜单栏“报告”按钮，填写相关信息，以出具报告。

![image55 png](../../../../assets/products/video-extensometer/image55.png)![image56 png](../../../../assets/products/video-extensometer/image56.png)

### 添加多组标距

在软件的图像显示区域任意位置单击鼠标右键，将出现“是否添加横向或纵向标记点”弹窗，根据实际需要进行添加。

![image57 png](../../../../assets/products/video-extensometer/image57.png)

### 固定标距

在使用无特征识别模式或试样表面已制作散斑时，可使用固定标距功能，在原始标距上面使用鼠标左键单击十字准星或方框可激活固定标距功能。

![image58 png](../../../../assets/products/video-extensometer/image58.png)

### 相机开关

在一次试验做完更换试样后，如需重新识别标准圆形标记点，可点击下图红色方框处按钮关闭相机后重新打开相机，即可重新识别。

![image59 png](../../../../assets/products/video-extensometer/image59.png)
...
![image60 png](../../../../assets/products/video-extensometer/image60.png)

# 6. 设备保养维护以及注意事项 <span id="_Toc15052"></span>
...
# ![image1 png](../../../../assets/products/video-extensometer/image1.png)

# 感谢您选用我公司产品！

![image61 png](../../../../assets/products/video-extensometer/image61.png)
![image62 png](../../../../assets/products/video-extensometer/image62.png)
![image63 png](../../../../assets/products/video-extensometer/image63.png)
